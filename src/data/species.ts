...
const list: SpeciesDef[] = [
  ...
  {
    id: 27, key: 'silkette', name: 'Silkette', types: ['Bug'],
    base: { hp: 45, atk: 40, def: 50, spa: 40, spd: 50, spe: 35 },
    catchRate: 190, expYield: 58, growth: 'fast', genderRatio: 0.5,
    eggGroups: ['Bug'], eggMoves: ['toxic'],
    abilities: ['rocksolid'], evYield: { def: 1 },
    learnset: [
      { lv: 1, move: 'tackle' }, { lv: 4, move: 'stringshot' }, { lv: 8, move: 'bugbite' },
      { lv: 12, move: 'harden' }, { lv: 15, move: 'doubleteam' }, { lv: 18, move: 'signalbeam' },
    ],
    evolution: { to: 'lumoth', method: 'level', level: 20 },
    dex: 'It spins silk finer than thread. Weavers follow it to learn new patterns.',
  },
  {
    id: 28, key: 'lumoth', name: 'Lumoth', types: ['Bug', 'Flying'],
    base: { hp: 70, atk: 55, def: 60, spa: 105, spd: 85, spe: 100 },
    catchRate: 75, expYield: 158, growth: 'fast', genderRatio: 0.5,
    eggGroups: ['Bug'], eggMoves: ['toxic'],
    abilities: ['airborne', 'adaptive'], evYield: { spa: 2 },
    learnset: [
      { lv: 1, move: 'gust' }, { lv: 1, move: 'stringshot' }, { lv: 8, move: 'bugbite' },
      { lv: 16, move: 'signalbeam' }, { lv: 20, move: 'airslash' }, { lv: 24, move: 'sleeppowder' },
      { lv: 28, move: 'xscissor' }, { lv: 32, move: 'fly' },
    ],
    dex: 'Its wing scales glow at dusk. Lost travellers follow the drifting light home.',
  },
  {
    id: 29, key: 'coralily', name: 'Coralily', types: ['Water', 'Grass'],
    base: { hp: 80, atk: 50, def: 78, spa: 92, spd: 90, spe: 40 },
    catchRate: 90, expYield: 140, growth: 'mediumslow', genderRatio: 0.5,
    eggGroups: ['Water1', 'Grass'], eggMoves: ['leechseed'],
    abilities: ['sponge', 'verdantforce'], evYield: { spd: 2 },
    learnset: [
      { lv: 1, move: 'absorb' }, { lv: 1, move: 'watergun' }, { lv: 6, move: 'harden' },
      { lv: 10, move: 'bubblebeam' }, { lv: 14, move: 'megadrain' }, { lv: 18, move: 'leechseed' },
      { lv: 22, move: 'energyball' }, { lv: 26, move: 'tidalcrash' }, { lv: 30, move: 'mend' },
    ],
    dex: 'A coral bloom that walks the shallows. Its petals filter salt from seawater.',
  },
  {
    id: 30, key: 'krabbet', name: 'Krabbet', types: ['Water'],
    base: { hp: 68, atk: 105, def: 90, spa: 45, spd: 55, spe: 62 },
    catchRate: 90, expYield: 145, growth: 'mediumfast', genderRatio: 0.5,
    eggGroups: ['Water1'], eggMoves: ['coldsnap'],
    abilities: ['riptide', 'rocksolid'], evYield: { atk: 2 },
    learnset: [
      { lv: 1, move: 'scratch' }, { lv: 1, move: 'harden' }, { lv: 5, move: 'watergun' },
      { lv: 9, move: 'furyswipes' }, { lv: 13, move: 'aquajet' }, { lv: 17, move: 'bubblebeam' },
      { lv: 21, move: 'rocktomb' }, { lv: 24, move: 'pincercrush' }, { lv: 28, move: 'tidalcrash' },
    ],
    dex: 'Its right pincer cracks boulders. It drums the rocks to warn off rivals.',
  },
  {
    id: 31, key: 'ampule', name: 'Ampule', types: ['Electric'],
    base: { hp: 45, atk: 45, def: 45, spa: 65, spd: 50, spe: 60 },
    catchRate: 190, expYield: 66, growth: 'mediumfast', genderRatio: 0.5,
    eggGroups: ['Field'], eggMoves: ['thunderwave'],
    abilities: ['staticfur'], evYield: { spa: 1 },
    learnset: [
      { lv: 1, move: 'tackle' }, { lv: 3, move: 'thundershock' }, { lv: 7, move: 'quickattack' },
      { lv: 11, move: 'spark' }, { lv: 15, move: 'doubleteam' }, { lv: 22, move: 'electricterrain' },
      { lv: 26, move: 'discharge' },
    ],
    dex: 'A living battery cell. Power stations keep a few around as backup lamps.',
  },
  {
    id: 32, key: 'dynabolt', name: 'Dynabolt', types: ['Electric'],
    base: { hp: 72, atk: 70, def: 65, spa: 115, spd: 80, spe: 108 },
    catchRate: 60, expYield: 172, growth: 'mediumfast', genderRatio: 0.5,
    eggGroups: ['Field'], eggMoves: ['thunderwave'],
    abilities: ['staticfur', 'momentum'], evYield: { spa: 2 },
    learnset: [
      { lv: 1, move: 'tackle' }, { lv: 1, move: 'thundershock' }, { lv: 11, move: 'spark' },
      { lv: 15, move: 'doubleteam' }, { lv: 22, move: 'electricterrain' }, { lv: 26, move: 'discharge' },
      { lv: 30, move: 'voltcharge' }, { lv: 34, move: 'lightscreen' },
    ],
    dex: 'It runs faster than the current in a wire. Streetlights flicker as it passes.',
  },
  {
    id: 33, key: 'bloomule', name: 'Bloomule', types: ['Grass'],
    base: { hp: 92, atk: 68, def: 82, spa: 75, spd: 78, spe: 45 },
    catchRate: 90, expYield: 148, growth: 'mediumslow', genderRatio: 0.5,
    eggGroups: ['Field', 'Grass'], eggMoves: ['sleeppowder'],
    abilities: ['verdantforce'], evYield: { hp: 2 },
    learnset: [
      { lv: 1, move: 'tackle' }, { lv: 1, move: 'growl' }, { lv: 6, move: 'vinewhip' },
      { lv: 10, move: 'absorb' }, { lv: 14, move: 'razorleaf' }, { lv: 18, move: 'leechseed' },
      { lv: 22, move: 'megadrain' }, { lv: 26, move: 'seedbomb' }, { lv: 30, move: 'energyball' },
      { lv: 34, move: 'grassyterrain' },
    ],
    dex: 'A patient pack beast. The blossom on its back reopens each spring for luck.',
  },
  {
    id: 34, key: 'cactoss', name: 'Cactoss', types: ['Grass', 'Ground'],
    base: { hp: 80, atk: 115, def: 85, spa: 60, spd: 75, spe: 70 },
    catchRate: 60, expYield: 168, growth: 'mediumslow', genderRatio: 0.5,
    eggGroups: ['Grass'], eggMoves: ['spikes'],
    abilities: ['toxicbarb', 'verdantforce'], evYield: { atk: 2 },
    learnset: [
      { lv: 1, move: 'scratch' }, { lv: 1, move: 'harden' }, { lv: 6, move: 'sandattack' },
      { lv: 10, move: 'absorb' }, { lv: 14, move: 'razorleaf' }, { lv: 18, move: 'mudslap' },
      { lv: 22, move: 'dig' }, { lv: 26, move: 'spikes' }, { lv: 30, move: 'seedbomb' },
      { lv: 34, move: 'toxic' },
    ],
    dex: 'It hurls its own spines in a spiral. Desert caravans give its ridge a wide berth.',
  },
  {
    id: 35, key: 'pyrelisk', name: 'Pyrelisk', types: ['Fire'],
    base: { hp: 68, atk: 85, def: 65, spa: 95, spd: 65, spe: 67 },
    catchRate: 75, expYield: 152, growth: 'mediumfast', genderRatio: 0.5,
    eggGroups: ['Field', 'Monster'], eggMoves: ['firefang'],
    abilities: ['cinderheart', 'embergut'], evYield: { spa: 2 },
    learnset: [
      { lv: 1, move: 'scratch' }, { lv: 1, move: 'growl' }, { lv: 6, move: 'ember' },
      { lv: 12, move: 'bite' }, { lv: 16, move: 'flameburst' }, { lv: 20, move: 'firefang' },
      { lv: 24, move: 'sunnyday' }, { lv: 28, move: 'dig' }, { lv: 32, move: 'flamethrower' },
    ],
    dex: 'A lizard that basks on volcanic glass. Its throat glows before it breathes fire.',
  },
  {
    id: 36, key: 'cindrake', name: 'Cindrake', types: ['Fire', 'Flying'],
    base: { hp: 80, atk: 98, def: 75, spa: 100, spd: 75, spe: 90 },
    catchRate: 45, expYield: 180, growth: 'slow', genderRatio: 0.5,
    eggGroups: ['Monster', 'Flying'], eggMoves: ['firefang'],
    abilities: ['cinderheart', 'menace'], evYield: { spa: 2 },
    learnset: [
      { lv: 1, move: 'scratch' }, { lv: 1, move: 'ember' }, { lv: 8, move: 'peck' },
      { lv: 14, move: 'bite' }, { lv: 18, move: 'flameburst' }, { lv: 22, move: 'wingattack' },
      { lv: 26, move: 'firefang' }, { lv: 30, move: 'airslash' }, { lv: 34, move: 'flamethrower' },
      { lv: 38, move: 'fly' },
    ],
    dex: 'A young drake no larger than a dog. Its sneeze scorches the treetops it nests in.',
  },
  {
    id: 37, key: 'skywyrm', name: 'Skywyrm', types: ['Flying'],
    base: { hp: 78, atk: 95, def: 70, spa: 88, spd: 75, spe: 110 },
    catchRate: 45, expYield: 178, growth: 'slow', genderRatio: 0.5,
    eggGroups: ['Flying', 'Monster'], eggMoves: ['coldsnap'],
    abilities: ['momentum', 'airborne'], evYield: { spe: 2 },
    learnset: [
      { lv: 1, move: 'peck' }, { lv: 1, move: 'gust' }, { lv: 8, move: 'quickattack' },
      { lv: 14, move: 'wingattack' }, { lv: 20, move: 'doubleteam' }, { lv: 26, move: 'airslash' },
      { lv: 32, move: 'ancientpower' }, { lv: 38, move: 'fly' }, { lv: 42, move: 'takedown' },
    ],
    dex: 'A sky serpent that rides the jet stream. Its coils carve spirals into the clouds.',
  },
  {
    id: 38, key: 'enigmew', name: 'Enigmew', types: ['Psychic'],
    base: { hp: 48, atk: 35, def: 42, spa: 72, spd: 58, spe: 55 },
    catchRate: 90, expYield: 72, growth: 'mediumslow', genderRatio: 0.5,
    eggGroups: ['Amorphous'], eggMoves: ['mend'],
    abilities: ['adaptive'], evYield: { spa: 1 },
    learnset: [
      { lv: 1, move: 'confusion' }, { lv: 4, move: 'growl' }, { lv: 8, move: 'doubleteam' },
      { lv: 12, move: 'confuseray' }, { lv: 16, move: 'psybeam' }, { lv: 22, move: 'lightscreen' },
      { lv: 28, move: 'reflect' }, { lv: 32, move: 'psyburst' },
    ],
    evolution: { to: 'oraculum', method: 'level', level: 34 },
    dex: 'It answers questions nobody asked aloud. Riddles form in the air around it.',
  },
  {
    id: 39, key: 'oraculum', name: 'Oraculum', types: ['Psychic'],
    base: { hp: 78, atk: 50, def: 75, spa: 135, spd: 100, spe: 82 },
    catchRate: 45, expYield: 190, growth: 'slow', genderRatio: 0.5,
    eggGroups: ['Amorphous'], eggMoves: ['mend'],
    abilities: ['adaptive', 'airborne'], evYield: { spa: 2 },
    learnset: [
      { lv: 1, move: 'confusion' }, { lv: 1, move: 'confuseray' }, { lv: 16, move: 'psybeam' },
      { lv: 22, move: 'lightscreen' }, { lv: 28, move: 'reflect' }, { lv: 34, move: 'psyburst' },
      { lv: 40, move: 'mend' }, { lv: 46, move: 'doubleteam' },
    ],
    dex: 'An unblinking eye of light. Scholars claim it reads the next hour, not the future.',
  },
  {
    id: 40, key: 'fossilisk', name: 'Fossilisk', types: ['Rock', 'Ground'],
    base: { hp: 80, atk: 100, def: 110, spa: 55, spd: 65, spe: 45 },
    catchRate: 45, expYield: 160, growth: 'mediumslow', genderRatio: 0.125,
    eggGroups: ['Mineral', 'Monster'], eggMoves: ['bite'],
    abilities: ['rocksolid'], evYield: { def: 2 },
    learnset: [
      { lv: 1, move: 'tackle' }, { lv: 1, move: 'harden' }, { lv: 8, move: 'rockthrow' },
      { lv: 12, move: 'mudslap' }, { lv: 16, move: 'sandattack' }, { lv: 20, move: 'rocktomb' },
      { lv: 24, move: 'dig' }, { lv: 28, move: 'ancientpower' }, { lv: 32, move: 'stealthrock' },
      { lv: 36, move: 'sandstorm' }, { lv: 40, move: 'takedown' },
    ],
    dex: 'Revived from a shell locked in shale. Its armour still smells of ancient seabeds.',
  },
  {
    id: 41, key: 'originon', name: 'Originon', types: ['Normal', 'Psychic'],
    base: { hp: 106, atk: 80, def: 85, spa: 150, spd: 105, spe: 74 },
    catchRate: 3, expYield: 220, growth: 'slow', genderRatio: null,
    eggGroups: ['Undiscovered'], eggMoves: [],
    abilities: ['adaptive'], evYield: { spa: 3 }, baseFriendship: 0,
    learnset: [
      { lv: 1, move: 'confusion' }, { lv: 1, move: 'mend' }, { lv: 10, move: 'psybeam' },
      { lv: 20, move: 'lightscreen' }, { lv: 30, move: 'reflect' }, { lv: 40, move: 'confuseray' },
      { lv: 50, move: 'psyburst' }, { lv: 55, move: 'originwave' }, { lv: 65, move: 'takedown' },
    ],
    dex: 'Said to be the first mind to open its eyes. It remembers a world before names.',
  },
];
