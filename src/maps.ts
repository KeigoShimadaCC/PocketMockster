...
const route1Encounters: EncounterEntry[] = [
  ...
  { species: 'thistling', minLv: 3, maxLv: 5, weight: 10 },
  { species: 'sparkit', minLv: 3, maxLv: 5, weight: 8 },
  { species: 'mudlet', minLv: 3, maxLv: 5, weight: 6 },
  { species: 'gustling', minLv: 3, maxLv: 5, weight: 5 },
  { species: 'flarat', minLv: 3, maxLv: 5, weight: 4 },
  { species: 'cocoonet', minLv: 4, maxLv: 6, weight: 3 },
  { species: 'pebblit', minLv: 4, maxLv: 6, weight: 2 },
  { species: 'floazy', minLv: 4, maxLv: 6, weight: 1 },
  { species: 'psywisp', minLv: 4, maxLv: 6, weight: 0.7 },
  { species: 'zapwing', minLv: 5, maxLv: 6, weight: 0.3 },
];
    ...
    npcs: [
      {
        ...
        trainer: {
          ...
          spriteKey: 'bugcatcher',
          party: [
            { species: 'buzzler', level: 4 },
            { species: 'thistling', level: 5 },
          ],
          prize: 120,
      ...
      },
      {
        ...
        trainer: {
          ...
          spriteKey: 'lass',
          party: [
            { species: 'fluffowl', level: 5 },
            { species: 'nibbit', level: 5 },
          ],
          prize: 150,
      ...
      },
      {
        ...
        trainer: {
          ...
          spriteKey: 'hiker',
          party: [
            { species: 'pebblit', level: 6 },
            { species: 'mudlet', level: 6 },
          ],
          prize: 240,
